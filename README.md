...
fiducials to calculate the transformations and further develop the systems that will place fibers within 5um RMS
...
same purpose. In a similar manner, the CI's illuminated ducials will allow us to measure the parameters needed
...
in the CS5 Z direction, the software accepts images of a IF or the DMM 100um pinhole that was projected onto
the TTF camera's surface, and creates a focus curve that solves for height adjustments. To guide our adjustment 
of the tip or tilt of the TTF, the DESI CI metrology software accepts images of the DMM 100um pinhole projected 
...
routines to locate a IF, or light from the 100um pinhole projected onto a camera CCD, in an image and find its
