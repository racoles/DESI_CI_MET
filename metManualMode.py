...
class metManualMode(tk.Tk):
    ...
    def CCDTipTiltZ(self):
        ...
        ttz = tipTiltZCCD()
        #Tip
        ttz.tipCCD(xInterA, xInterB, xInterC, nominalZA, nominalZB, nominalZC, self.CCDSelection, fC.tccs, fC.micrometer_distance, self.consoleLog, self.logFile)
        #Tilt
        ttz.tiltCCD(xInterA, xInterB, xInterC, nominalZA, nominalZB, nominalZC, self.CCDSelection, fC.tccs, fC.micrometer_distance, self.consoleLog, self.logFile)
        #Z
        ttz.ZCCD(xInterA, xInterB, xInterC, self.CCDSelection, fC.tccs, fC.micrometer_distance, self.consoleLog, self.logFile)
