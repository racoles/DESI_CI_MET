...
#Note: in future, row versus columns equal to x and y will be different for NESW cameras
        ...
        DeltaX_CS5_A_Sensor_Center
        DeltaY_CS5_A_Sensor_Center
        
        DeltaX_CS5_B_Sensor_Center
        DeltaY_CS5_B_Sensor_Center
        
        DeltaX_CS5_C_Sensor_Center
        DeltaY_CS5_C_Sensor_Center
