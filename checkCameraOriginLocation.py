...
#Note: in future, row versus columns equal to x and y will be different for NESW cameras
        ...
        faah.pageLogging(consoleLog, logFile, "CS5 CCD ORIGIN\n\n" +
                        ...
                        "    CS5 CCD Origin Y(B) = " + format(fC.trianglePonitCCDLocationsCS5[self.CCDSelection + "B"][1], '.3f') - ((format(yCenGMSB, '.3f') + str(yOffsetB) * pixelSize), '.3f') + "\n\n" +
                        ...
                        "    CS5 CCD Origin X(A) = " + format(fC.trianglePonitCCDLocationsCS5[self.CCDSelection + "A"][0], '.3f') - ((format(xCenGMSA, '.3f') + str(xOffsetA)) * pixelSize) + format(calOffX, '.3f') + "\n" +
                        "    CS5 CCD Origin Y(A) = " + format(fC.trianglePonitCCDLocationsCS5[self.CCDSelection + "A"][1], '.3f') - ((format(yCenGMSA, '.3f') + str(yOffsetA)) * pixelSize) + format(calOffY, '.3f') + "\n\n" +
                        "    CS5 CCD Origin X(B) = " + format(fC.trianglePonitCCDLocationsCS5[self.CCDSelection + "B"][0], '.3f') - ((format(xCenGMSB, '.3f') + str(xOffsetB)) * pixelSize) + format(calOffX, '.3f') + "\n" +
                        "    CS5 CCD Origin Y(B) = " + format(fC.trianglePonitCCDLocationsCS5[self.CCDSelection + "B"][1], '.3f') - ((format(yCenGMSB, '.3f') + str(yOffsetB)) * pixelSize) + format(calOffY, '.3f') + "\n\n" +
                        "    CS5 CCD Origin X(C) = " + format(fC.trianglePonitCCDLocationsCS5[self.CCDSelection + "C"][0], '.3f') - ((format(xCenGMSC, '.3f') + str(xOffsetC)) * pixelSize) + format(calOffX, '.3f') + "\n" +
                        "    CS5 CCD Origin Y(C) = " + format(fC.trianglePonitCCDLocationsCS5[self.CCDSelection + "C"][1], '.3f') - ((format(yCenGMSC, '.3f') + str(yOffsetC)) * pixelSize) + format(calOffY, '.3f'))
